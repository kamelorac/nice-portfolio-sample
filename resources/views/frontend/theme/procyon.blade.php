...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar ftco-navbar-light site-navbar-target" id="ftco-navbar">
        <div class="container">
            <a class="navbar-brand"
                href="#"><span>{{ substr($about->name, 0, 1) }}</span>{{ substr($about->name, 1) }}</a>
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav nav ml-auto">
                    ...
                    @endif
                    @if (
                        $portfolioConfig['visibility']['experiences'] ||
                            $portfolioConfig['visibility']['education'] ||
    ...
    <section class="hero-wrap js-fullheight" id="hero"
                    ...
                    <div class="col-md-6 col-lg-6 pl-md-5 py-5">
                        <div class="row justify-content-start pb-3">
                            <div class="col-md-12 heading-section">
                                ...
                                <p class="white-space">{{ $about->description }}</p>
                                <ul class="about-info mt-4 px-md-0 px-2">
                                    ...
                                    @if ($about->address && $about->address !== '')
                                        <li class="d-flex"><span>Address:</span> <span>{{ $about->address }}</span>
                                        </li>
                                    @endif
                                </ul>
                            </div>
                        ...
                        @if ($portfolioConfig['visibility']['cv'])
                            <div class="counter-wrap d-flex mt-md-3" data-aos="fade-up"
                                data-aos-anchor-placement="top-bottom">
                                <div class="text">
                                    <p><a href="{{ $about->cv }}" class="btn btn-primary py-3 px-3"
                                            download>Download CV</a></p>
                                </div>
                            </div>
                        @endif
                    </div>
                            ...
                            <div id="page-1" class="page one">
                                ...
                                @if ($education)
                                    @foreach ($education as $value)
                                        <div class="resume-wrap d-flex" data-aos="fade-up"
                                            data-aos-anchor-placement="top-bottom">
                                            <div class="icon d-flex align-items-center justify-content-center">
                                            ...
                                            <div class="text pl-3">
                                                ...
                                                <p class="mb-0">
                                                    {{ $value->cgpa && $value->cgpa !== '' ? 'CGPA: ' . $value->cgpa : '' }}
                                                </p>
                                                <p>{{ $value->thesis && $value->thesis !== '' ? 'Thesis: ' . $value->thesis : '' }}
                                                </p>
                                            </div>
                                        </div>
                                    @endforeach
                                    ...
                                    @foreach ($experiences as $experience)
                                        <div class="resume-wrap d-flex" data-aos="fade-up"
                                            ...
                                            <div class="text pl-3">
                                                ...
                                                <p class="white-space">{{ $experience->details }}</p>
                                            </div>
                                        </div>
                                    @endforeach
                                @endif
                                                    ...
                                                    <div class="col-lg-3 mb-4" data-aos="zoom-in">
                                                        <div class="bg-white rounded-lg shadow p-4 z-hover">
                                                            <h2 class="h5 font-weight-bold text-center mb-4">
                                                                {{ $skill->name }}</h2>
                                                            <div class="progress mx-auto mb-4"
                                    ...
                                    @if (!empty($skills))
                                        <div class="row">
                                            @foreach ($skills as $key => $skill)
                                                @if ($key >= 3)
                                                    <div class="col-md-6">
                                                        <div class="progress-wrap" data-aos="fade-up"
                                                            data-aos-anchor-placement="top-bottom">
                                                            <h3>{{ $skill->name }}</h3>
                                                            <div class="progress">
                                    ...
                                    <div class="row progress-circle mb-5">
                                        @foreach ($skills as $key => $skill)
                                            <div class="col-lg-4 col-md-6 mb-4" data-aos="zoom-in">
                                                <div class="bg-white rounded-lg shadow p-4 z-hover">
                                                    <h2 class="h5 font-weight-bold text-center">{{ $skill->name }}
                                                    </h2>
                                                </div>
                                            </div>
                                        @endforeach
                                    ...
                                    <div>
                                        <a href="{{ $about->cv }}" class="text-muted" download>
                                            <svg stroke="currentColor" fill="currentColor" stroke-width="0"
                                                version="1.1" viewBox="0 0 16 16" height="1.5rem" width="1.5rem"
