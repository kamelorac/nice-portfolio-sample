...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">
            ...
            <span class="d-none d-lg-block"><img class="lazy img-fluid img-profile rounded-circle mx-auto mb-2"
                    ...
                    @if ($experiences)
                        @foreach ($experiences as $experience)
                            <div class="d-flex flex-column flex-md-row justify-content-between mb-5"
                                ...
                                {!! $experience->period
                                    ? '<div class="flex-shrink-0"><span class="text-primary">' . $experience->period . '</span></div>'
                                    : '' !!}
                            </div>
                        @endforeach
                    @endif
                    ...
                    @if ($education)
                        @foreach ($education as $value)
                            <div class="d-flex flex-column flex-md-row justify-content-between mb-5"
                                ...
                                <div class="flex-shrink-0"><span class="text-primary">{!! $value->period ? $value->period : '' !!}</span>
                                </div>
                            </div>
                        @endforeach
                    @endif
                            ...
                            @foreach ($skills as $skill)
                                <div class="col-6 col-md-4 col-lg-2" data-aos="zoom-in">
                                    <div class="card z-hover skill-card text-center">
                                        <div
                                            class="card-body{{ !(int) $portfolioConfig['visibility']['skillProficiency'] ? ' center-this' : '' }}">
                                        ...
                                        <div>
                                            <a href="{{ $about->cv }}" class="text-muted" download>
                                                <svg stroke="currentColor" fill="currentColor" stroke-width="0"
                                                    version="1.1" viewBox="0 0 16 16" height="1.5rem"
